...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        # Learnable Matrices
        self.PosMatrix = nn.Parameter(torch.ones(120))
        self.NegMatrix = nn.Parameter(torch.ones(120))
        self.inception_v3 = models.inception_v3(pretrained=True)
        self.FAM_Aligh = FAM_Aligh(1000, base_channel*4)
